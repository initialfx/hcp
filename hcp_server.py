...
logger = logging.getLogger("Hcp_StdioServer")
    ...
    def send_command(self, cmd_type: str, params: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        if not self.protocol_verified:
            try:
                ...
                return {
                    "status": "error",
                    "message": "Houdini plugin protocol mismatch. Please restart the HCP server in Houdini using the shelf tool, then retry.",
